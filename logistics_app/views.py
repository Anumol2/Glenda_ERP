...
from logistics_app.forms import DriverForm, VehicleForm, RouteForm, RoutePlanForm, VehicleMaintenanaceForm
...
def view_driver(request):
    ...
    today = date.today()
    return render(request, 'logistics/view_driver.html', {'allocated_menus': allocated_menus, 'dr': dr})
